...
class Utility extends Model
{
    ...
    public static function fetchSettings($admin_id = null)
    {
        $data = DB::table('settings');
        if ($admin_id != null) {
            $admin = Admin::where('id', $admin_id)->first();
            if ($admin_id) {
                $data = $data->where('created_by', '=', $admin_id)->get();
            } else {
    ...
    {
        $colors = [
            'blue', 'denim', 'sapphire', 'olympic', 'violet', 'black', 'cyan', 'dark-blue-natural',
            'gray-dark', 'light-blue', 'light-purple', 'magenta', 'orange-mute', 'pale-green',
            'rich-magenta', 'rich-red', 'sky-gray', 'pinkish-red' // Added pinkish-red
        ];
        return $colors;
    }
