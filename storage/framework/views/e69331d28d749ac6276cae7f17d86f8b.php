...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?php echo e(asset('storage/uploads/logo/hima.png')); ?>" type="image/x-icon" />
                        ...
                        <div class="row">
                            <div class="col-12">
                                <span>
                                    ...
                                    <?php endif; ?>
                                    <?php echo e(App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : config('app.name', 'Hi ma')); ?>
...
<?php /**PATH C:\xampp\htdocs\hima_admin_panel-1\resources\views/layouts/auth.blade.php ENDPATH**/ ?>