...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Customer Verification List')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Home')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Customer Verification List')); ?></li>
<?php $__env->stopSection(); ?>
    ...
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('customers-verification.index')); ?>" method="GET" class="mb-3">
                ...
                <!-- Table for customer verifications -->
                <form action="<?php echo e(route('customers-verification.updateStatus')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="selectable-row">
                                            <td><input type="checkbox" class="customer-checkbox" name="customer_ids[]" value="<?php echo e($customer->id); ?>"></td>
                                            <td><?php echo e($customer->id); ?></td>
                                            <td><?php echo e(ucfirst($customer->name)); ?></td>
                                            <td><?php echo e($customer->mobile); ?></td>
                                            <td>
                                                <?php if($customer->voice && $customer->voice): ?>
                                                    <a href="<?php echo e(asset('storage/app/public/voice/' . $customer->voice)); ?>" target="_blank">Play Voice</a>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new_hi_ma\resources\views/customers-verification/index.blade.php ENDPATH**/ ?>