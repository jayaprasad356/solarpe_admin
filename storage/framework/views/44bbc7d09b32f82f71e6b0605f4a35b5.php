...
<div class="navbar-wrapper">
    <div class="m-header main-logo">
        <a href="<?php echo e(route('dashboard')); ?>" class="b-brand">
            ...
            <img src="<?php echo e(asset('storage/uploads/logo/hi_dude.png')); ?>" alt="Logo"
...
<?php /**PATH C:\xampp\htdocs\hidudes_admin\resources\views/partial/Admin/menu.blade.php ENDPATH**/ ?>