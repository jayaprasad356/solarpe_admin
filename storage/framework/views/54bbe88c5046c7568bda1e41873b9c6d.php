<?php
    ...
    $color = !empty($setting['theme_color']) ? $setting['theme_color'] : 'theme-5';
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon"
        href="<?php echo e(asset('storage/uploads/logo/hima.png')); ?>"
        type="image/x-icon" />
    <!-- for calender-->
...
<?php /**PATH C:\xampp\htdocs\hima_admin_panel-1\resources\views/layouts/admin.blade.php ENDPATH**/ ?>