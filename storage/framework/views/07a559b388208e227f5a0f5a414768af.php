    ...
    <div class="card-body">
        ...
        <div class="custom-login-form">
            <div class="form-group mb-3">
                ...
                <input id="name" type="text" class="form-control" name="name" placeholder="<?php echo e(__('Enter Full Name')); ?>"
                    required autofocus>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u743445510/domains/graymatterworks.com/public_html/ems/resources/views/auth/register.blade.php ENDPATH**/ ?>