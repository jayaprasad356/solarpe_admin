...
<head>
    ...
    <meta property="og:image"
        content="<?php echo e(isset($meta_logo) && !empty(asset('storage/uploads/meta/' . $meta_logo)) ? asset('storage/uploads/meta/' . $meta_logo) : 'EMS.png'); ?>">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-md  default top-nav-collapse">
                ...
                <a class="navbar-brand bg-transparent" href="#">
                   <img src="<?php echo e($sup_logo . '/' . $settings['4_light_logo'] . '?' . time()); ?>" alt="logo" style="width: 50px; height: auto;">
                   </a>       
                </div>
...
<footer class="site-footer bg-gray-100">
    ...
    <div class="border-top border-dark text-center p-2">
        ...
        <?php echo e(App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : config('app.name', 'EMS SaaS')); ?>
...
<?php /**PATH C:\xampp\htdocs\ems\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>