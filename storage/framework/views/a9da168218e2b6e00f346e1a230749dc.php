                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <?php echo e(Form::text('nepalste_public_key', isset($admin_payment_setting['nepalste_public_key']) ? $admin_payment_setting['nepalste_public_key'] : '', ['class' => 'form-control', 'placeholder' => __('Public Key')])); ?><br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <?php echo e(Form::text('nepalste_secret_key', isset($admin_payment_setting['nepalste_secret_key']) ? $admin_payment_setting['nepalste_secret_key'] : '', ['class' => 'form-control', 'placeholder' => __('Secret Key')])); ?><br>
                                                                ...
                                                                <div class="row gy-4">
                                                                    <div class="col-lg-6">
                                                                        <div class="input-edits">
                                                                            <div class="form-group">
                                                                                <label class="col-form-label"
                                                                                    for="fedapay_public_key"><?php echo e(__('Public Key')); ?></label>
                                                                                <input type="text"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="input-edits">
                                                                            <div class="form-group">
                                                                                <label class="col-form-label"
                                                                                    for="fedapay_secret_key"><?php echo e(__('Secret Key')); ?></label>
                                                                                <input type="text"
                                                                ...
                                                                <div class="row gy-4">
                                                                    <div class="col-lg-6">
                                                                        <div class="input-edits">
                                                                            <div class="form-group">
                                                                                <label class="col-form-label"
                                                                                    for="payhere_merchant_id"><?php echo e(__('Merchant ID')); ?></label>
                                                                                <input type="text"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="input-edits">
                                                                            <div class="form-group">
                                                                                <label class="col-form-label"
                                                                                    for="payhere_merchant_secret"><?php echo e(__('Merchant Secret')); ?></label>
                                                                                <input type="text"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="input-edits">
                                                                            <div class="form-group">
                                                                                <label class="col-form-label"
                                                                                    for="payhere_app_id"><?php echo e(__('App ID')); ?></label>
                                                                                <input type="text"
                                                                                    name="payhere_app_id"
                                                                                    id="payhere_app_id"
                                                                                    class="form-control"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="input-edits">
                                                                            <div class="form-group">
                                                                                <label class="col-form-label"
                                                                                    for="payhere_app_secret"><?php echo e(__('App Secret')); ?></label>
                                                                                <input type="text"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                ...
                                                <input class="form-control " placeholder="Enter Pusher App Secret"
                                                    ...
                                                    value="<?php echo e($setting['pusher_app_secret']); ?>"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                ...
                                                <input class="form-control " placeholder="Enter Pusher App Cluster"
                                                    ...
                                                    value="<?php echo e($setting['pusher_app_cluster']); ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                            ...
                                            <input class="form-control"
                                                ...
                                                value="<?php echo e($setting['google_recaptcha_key']); ?>"
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                            ...
                                            <input class="form-control "
                                                ...
                                                value="<?php echo e($setting['google_recaptcha_secret']); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\payroll\resources\views/setting/system_settings.blade.php ENDPATH**/ ?>