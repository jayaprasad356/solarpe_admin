    ...
    $('body').on('click', '#regenerate', function() {
        ...
        $.ajax({
            ...
            afterSend: function(msg) {
                $("#regenerate").empty();
                var html =
                    `<a class="btn btn-primary" href="#!" id="regenerate"><?php echo e(__('Generate')); ?></a>`;
...
<?php /**PATH /home/u743445510/domains/graymatterworks.com/public_html/ems/resources/views/template/grammar_ai.blade.php ENDPATH**/ ?>