                    ...
                    <div class="card ">
                        <div class="card-body employee-detail-body fulls-card emp-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold"><?php echo e(__('Employee Code')); ?> :</strong>
                                        <span><?php echo e(!empty($employee->biometric_emp_id) ? $employee->biometric_emp_id : ''); ?></span>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u743445510/domains/graymatterworks.com/public_html/ems/resources/views/employee/show.blade.php ENDPATH**/ ?>